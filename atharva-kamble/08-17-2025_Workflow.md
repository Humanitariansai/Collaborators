...
* Money moved in a way that looks wrong and we are not sure why  
* The ride record has missing steps in the timeline  
* The panel will not save our change and shows an error

How to escalate  
* Add a clear one line summary at the top of the ticket  
* Tag the correct team such as safety or finance  
* Paste the link to the profile or trip we opened

## Writing clear updates
* Use simple sentences  
* One topic per paragraph  
* State what we did and why  
...
Outcome  
We can move tickets from start to finish without confusion, call for help at the right moments, and keep quality visible through a few simple numbers.
